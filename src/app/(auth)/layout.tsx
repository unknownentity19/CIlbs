      ...
      <aside className="relative hidden lg:flex lg:w-[40%] xl:w-[44%] items-center justify-center overflow-hidden border-l border-border bg-muted/40">
        ...
        <div className="relative max-w-md px-10">
          ...
          <div className="mt-6 flex items-center gap-3">
            {/* A synthetic face — generated by StyleGAN2, not a photograph
                of anyone. The quote is written copy, so a real person's
                likeness here would present an actual human as endorsing the
                product, which stock licences forbid in any case. */}
            <Image
              src="/testimonial-oliver.jpg"
              alt=""
              width={36}
              height={36}
